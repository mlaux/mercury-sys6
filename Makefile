...
Mercury  ÄÄ  {ObjFiles-68K} {LibFiles-68K} {RezFiles}
	ILink ¶
		-o {Targ} ¶
		{ObjFiles-68K} ¶
		{LibFiles-68K} ¶
...
"{ObjDir}tcp.c.o"  Ä  tcp.c
"{ObjDir}dnr.c.o"  Ä  dnr.c
"{ObjDir}irc.c.o"  Ä  irc.c
"{ObjDir}netutil.c.o" Ä netutil.c
"{ObjDir}str_compat.c.o" Ä str_compat.c
"{ObjDir}mercury.c.o" Ä mercury.c
"{ObjDir}mercury.r" Ä mercury.rc